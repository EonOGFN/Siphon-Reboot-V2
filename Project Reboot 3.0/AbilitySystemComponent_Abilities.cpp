...
{
	static auto NetMulticast_InvokeGameplayCueAddedFn = FindObject<UFunction>(L"/Script/GameplayAbilities.AbilitySystemComponent.NetMulticast_InvokeGameplayCueAdded");

	auto Params = Alloc(NetMulticast_InvokeGameplayCueAddedFn->GetPropertiesSize());
	...
	static auto PredictionKeyOffset = FindOffsetStruct("/Script/GameplayAbilities.AbilitySystemComponent.NetMulticast_InvokeGameplayCueAdded", "PredictionKey");
	static auto EffectContextOffset = FindOffsetStruct("/Script/GameplayAbilities.AbilitySystemComponent.NetMulticast_InvokeGameplayCueAdded", "EffectContext");

	*(FGameplayTag*)(__int64(Params) + GameplayCueTagOffset) = GameplayCueTag;
	*(FPredictionKey*)(__int64(Params) + PredictionKeyOffset) = PredictionKey;
	*(FGameplayEffectContextHandle*)(__int64(Params) + EffectContextOffset) = EffectContext;

	this->ProcessEvent(NetMulticast_InvokeGameplayCueAddedFn, Params);
...
{
	static auto NetMulticast_InvokeGameplayCueExecutedFn = FindObject<UFunction>(L"/Script/GameplayAbilities.AbilitySystemComponent.NetMulticast_InvokeGameplayCueExecuted");

	auto Params = Alloc(NetMulticast_InvokeGameplayCueExecutedFn->GetPropertiesSize());
	...
	static auto PredictionKeyOffset = FindOffsetStruct("/Script/GameplayAbilities.AbilitySystemComponent.NetMulticast_InvokeGameplayCueExecuted", "PredictionKey");
	static auto EffectContextOffset = FindOffsetStruct("/Script/GameplayAbilities.AbilitySystemComponent.NetMulticast_InvokeGameplayCueExecuted", "EffectContext");

	*(FGameplayTag*)(__int64(Params) + GameplayCueTagOffset) = GameplayCueTag;
	*(FPredictionKey*)(__int64(Params) + PredictionKeyOffset) = PredictionKey;
	*(FGameplayEffectContextHandle*)(__int64(Params) + EffectContextOffset) = EffectContext;

	this->ProcessEvent(NetMulticast_InvokeGameplayCueExecutedFn, Params);
